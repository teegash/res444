...
import { LayoutDashboard, Building2, Users, CreditCard, Wrench, MessageSquare, BarChart3, User, Settings, LogOut, ChevronDown } from 'lucide-react'

const menuItems = [
  { icon: LayoutDashboard, label: 'Dashboard', href: '#' },
  { icon: Building2, label: 'My Properties', href: '#' },
  { icon: Users, label: 'My Tenants', href: '#' },

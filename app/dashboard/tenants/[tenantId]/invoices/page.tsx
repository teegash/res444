...
export default function ManagerTenantInvoicesPage() {
  ...
  useEffect(() => {
    ...
    const fetchInvoices = async () => {
      try {
        setLoading(true)
        const response = await fetch(`/api/tenants/${encodeURIComponent(tenantId)}/invoices`, { cache: 'no-store' })
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6 lg:p-8 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>All invoices issued to this tenant across their leases.</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-3">
                {filteredInvoices.map((invoice) => {
                  ...
                  return (
                    <div
                      key={invoice.id}
                      className="flex flex-col gap-4 rounded-xl border border-slate-200/70 bg-white p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between"
                    >
